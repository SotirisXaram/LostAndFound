...
//BCrypt.checkpw(txtPassword.getText().trim(), hashedPassword)
        ...
        //scene.getStylesheets().add(getClass().getResource("com/charamidis/style.css").toExternalForm());
        scene.getStylesheets().add(getClass().getClassLoader().getResource("com/charamidis/lostAndFound/styles/style.css").toExternalForm());
