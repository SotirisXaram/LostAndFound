...
public class ItemsLastYear {
    ...
    public ItemsLastYear(Connection conn) {
        ...
        window.setTitle("Lost Items Last Year");
    ...
    private void updateChart() {
        ...
        try {
            ...
            String query = "SELECT TO_CHAR(found_date, 'YYYY-MM') AS month, COUNT(*) AS count " +
                    "FROM records " +
                    "WHERE found_date BETWEEN '" + lastYearDate + "' AND '" + currentDate + "' " +
        ...
        data.setName("Items Found in the Last Year");
